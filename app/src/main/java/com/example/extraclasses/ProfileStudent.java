...
public class ProfileStudent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditS = findViewById(R.id.EditsBtn);
        home=findViewById(R.id.AccountToHomeS);
        fav = findViewById(R.id.AccountToFavorite);
...
//
        ...
        logOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(ProfileStudent.this, "Loged out",
