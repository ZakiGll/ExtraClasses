...
//reload();
    ...
    public void onRegister(View v) {
        final EditText
                emailView=(EditText)findViewById(R.id.emailT);
        final String email= emailView.getText().toString();
        final EditText passwordView=(EditText)findViewById(R.id.passwordTeacherR);
        final String password= passwordView.getText().toString();
        final EditText nameS = (EditText)findViewById(R.id.nameTeacherR);
        final String name= nameS.getText().toString();
        final EditText AgeS = (EditText)findViewById(R.id.AgeTeacherR);
...
// Sign in success, update UI with the signed-in user's information
                            ...
                            Toast.makeText(TeacherRegister.this, "User account added.",
